...
type GreetServiceClient interface {
	//Unary
	Greet(ctx context.Context, in *GreetRequest, opts ...grpc.CallOption) (*GreetRespone, error)
	//Server Streaming
...
func (c *greetServiceClient) Greet(ctx context.Context, in *GreetRequest, opts ...grpc.CallOption) (*GreetRespone, error) {
	out := new(GreetRespone)
	err := c.cc.Invoke(ctx, "/phonebookpb.GreetService/Greet", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *greetServiceClient) GreetManyTimes(ctx context.Context, in *GreetManyTimesRequest, opts ...grpc.CallOption) (GreetService_GreetManyTimesClient, error) {
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[0], "/phonebookpb.GreetService/GreetManyTimes", opts...)
	if err != nil {
		return nil, err
	}
...
type GreetService_GreetManyTimesClient interface {
	Recv() (*GreetManyTimesRespone, error)
	grpc.ClientStream
}
...
func (x *greetServiceGreetManyTimesClient) Recv() (*GreetManyTimesRespone, error) {
	m := new(GreetManyTimesRespone)
...
func (c *greetServiceClient) LongGreet(ctx context.Context, opts ...grpc.CallOption) (GreetService_LongGreetClient, error) {
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[1], "/phonebookpb.GreetService/LongGreet", opts...)
	if err != nil {
		return nil, err
	}
...
type GreetService_LongGreetClient interface {
	...
	CloseAndRecv() (*LongGreetRespone, error)
	grpc.ClientStream
}
...
func (x *greetServiceLongGreetClient) CloseAndRecv() (*LongGreetRespone, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(LongGreetRespone)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *greetServiceClient) GreetEveryone(ctx context.Context, opts ...grpc.CallOption) (GreetService_GreetEveryoneClient, error) {
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[2], "/phonebookpb.GreetService/GreetEveryone", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *greetServiceClient) GreetWithDeadLine(ctx context.Context, in *GreetWithDeadlineRequest, opts ...grpc.CallOption) (*GreetWithDeadlineRespone, error) {
	...
	err := c.cc.Invoke(ctx, "/phonebookpb.GreetService/GreetWithDeadLine", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GreetServiceServer interface {
	//Unary
	Greet(context.Context, *GreetRequest) (*GreetRespone, error)
	//Server Streaming
...
func (UnimplementedGreetServiceServer) Greet(context.Context, *GreetRequest) (*GreetRespone, error) {
...
func _GreetService_Greet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/phonebookpb.GreetService/Greet",
	}
...
type GreetService_GreetManyTimesServer interface {
	Send(*GreetManyTimesRespone) error
	grpc.ServerStream
}
...
func (x *greetServiceGreetManyTimesServer) Send(m *GreetManyTimesRespone) error {
...
type GreetService_LongGreetServer interface {
	SendAndClose(*LongGreetRespone) error
...
func (x *greetServiceLongGreetServer) SendAndClose(m *LongGreetRespone) error {
	return x.ServerStream.SendMsg(m)
}
...
func _GreetService_GreetWithDeadLine_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/phonebookpb.GreetService/GreetWithDeadLine",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var GreetService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "phonebookpb.GreetService",
	...
	Metadata: "phonebook/phonebookpb/phonebookpb.proto",
}
